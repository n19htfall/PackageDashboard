...
Package Dashboard is a cross-ecosystem Software Composition Analysis (SCA) web app. It combines a FastAPI backend with a Vue/Vite frontend to present package metadata, dependencies, and repository health in one place.
